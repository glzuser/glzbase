        ...
        no={() => (
          <>
            ...
            <ListItemLink
                ...
                icon={<TbBrandWhatsapp style={{ height: "25px", width: "25px", color: "#00BF63"}} />}
              />
              <ListItemLink
                to="/quick-messages"
                primary={i18n.t("mainDrawer.listItems.quickMessages")}
                icon={<TbMessageCircleBolt style={{ height: "25px", width: "25px", color: "#00BF63"}} />}
              />
              {showKanban && (
                <ListItemLink
                  to="/kanban"
                  primary="Kanban"
                  icon={<TbChartTreemap style={{ height: "25px", width: "25px", color: "#00BF63"}} />}
                />
              )}
              <ListItemLink
                to="/todolist"
              ...
              <ListItemLink
                ...
                icon={<TbAddressBook style={{ height: "25px", width: "25px", color: "#00BF63"}} />}
              />
              {showSchedules && (
                <>
                  <ListItemLink
                    ...
                    icon={<TbClockEdit style={{ height: "25px", width: "25px", color: "#00BF63"}} />}
                  />
                </>
              )}
              <ListItemLink
                ...
                icon={<LocalOfferIcon style={{ height: "25px", width: "25px", color: "#00BF63"}}/>}
              />
              {showInternalChat && (
                <>
                  <ListItemLink
                    ...
                    icon={<TbMessageChatbot style={{ height: "25px", width: "25px", color: "#00BF63"}} />}
                  />
                </>
              )}
              <ListItemLink
                ...
                icon={<TbHelpSquareRounded style={{ height: "25px", width: "25px", color: "#00BF63"}} />}
              />
            </>
          </>
        )}
